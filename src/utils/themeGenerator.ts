...
// Preset Curated Bespoke Tailor Logos for immediate one-click testing
export const SAMPLE_ATELIER_LOGOS = [
  {
    name: 'Savile Row Cobalt',
    subtitle: 'Deep Navy & Gilded Brass',
    primary: '#162b4d',
    accent: '#d4af37',
    url: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 200 200"><rect width="200" height="200" rx="36" fill="%23162b4d"/><circle cx="100" cy="100" r="70" fill="none" stroke="%23d4af37" stroke-width="4"/><path d="M70 135 L100 65 L130 135 M82 115 L118 115" stroke="%23d4af37" stroke-width="6" fill="none" stroke-linecap="round"/><circle cx="100" cy="100" r="8" fill="%23f3e6d8"/></svg>',
  },
  {
    name: 'Milanese Umber',
    subtitle: 'Earthy Cognac & Warm Ochre',
    primary: '#7A4E2D',
    accent: '#C49A6C',
    url: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 200 200"><rect width="200" height="200" rx="36" fill="%237a4e2d"/><path d="M55 140 C55 80 145 80 145 140 Z" fill="%23c49a6c"/><circle cx="100" cy="75" r="28" fill="%23f3e6d8"/><path d="M85 105 L100 135 L115 105 Z" fill="%237a4e2d"/></svg>',
  },
  {
    name: 'Parisian Emerald Velvet',
    subtitle: 'Imperial Forest & Champagne Gold',
    primary: '#17402f',
    accent: '#e5c158',
    url: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 200 200"><rect width="200" height="200" rx="36" fill="%2317402f"/><polygon points="100,40 155,95 100,150 45,95" fill="none" stroke="%23e5c158" stroke-width="5"/><circle cx="100" cy="95" r="24" fill="%23f4fbf7"/><path d="M90 95 L100 82 L110 95 L100 108 Z" fill="%2317402f"/></svg>',
  },
  {
    name: 'Florentine Burgundy Silk',
    subtitle: 'Deep Crimson & Rose Pearl',
    primary: '#6b1d2f',
    accent: '#d97d8f',
    url: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 200 200"><rect width="200" height="200" rx="36" fill="%236b1d2f"/><circle cx="100" cy="100" r="65" fill="%23fff2f4"/><path d="M75 75 C75 125 125 75 125 125" stroke="%236b1d2f" stroke-width="8" fill="none" stroke-linecap="round"/><circle cx="100" cy="100" r="12" fill="%23d97d8f"/></svg>',
  },
  {
    name: 'Nordic Slate & Amber',
    subtitle: 'Charcoal Minimalist & Honey',
    primary: '#2d3748',
    accent: '#d69e2e',
    url: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 200 200"><rect width="200" height="200" rx="36" fill="%232d3748"/><rect x="60" y="60" width="80" height="80" rx="16" fill="%23d69e2e"/><path d="M85 85 L115 115 M115 85 L85 115" stroke="%23ffffff" stroke-width="6" stroke-linecap="round"/></svg>',
  },
];
